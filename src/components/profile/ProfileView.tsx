...
import { User, Mail, Lock, LogOut, ChevronRight, HelpCircle } from "lucide-react";
    ...
    <div style={{ maxWidth: 480, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div className="card" style={{ padding: 0, overflow: "hidden", marginBottom: 16 }}>
        {[
          ...
          { icon: <HelpCircle size={18} />, label: "Help & Support", sub: "Contact customer support", action: () => router.push(ROUTES.SUPPORT) },
        ].map((item, idx) => (
